...
class DrawViewController: UIViewController, DrawViewDelegate, DrawModelDelegate, ColorControlDelegate {
    ...
    private var viewHolder: DrawViewHolder {
        return view as! DrawViewHolder
    }
    ...
    override func loadView() {
        view = DrawViewHolder(frame: UIScreen.main.bounds)
